...
Event.create(
  {
    ...
    number: 6,
    rules:
      "i)	Each College/Institution can send one participant. <br>ii)	The number of accompanists should not be more than two. <br>iii)	Time allotted is not less than 4 minutes and not more than 6 minutes. <br>iv)	Judgment will be made on qualities like voice, composition, rhythm, co-ordination and general impression etc. ",
    category: "team",
    maxPart: 3,
    type: "Music"
  },
...
Event.create(
  {
    ...
    number: 13,
    rules:
      "i)	A college/institute may participate with one team consisting of 2 participants.<br>ii)	Time allotted is not less than 5 minutes and not more than 7 minutes.<br>iii)	Max number of accompanists is 2.<br>iv)	Judgment will be based upon synchronizes, composition, impression, coordination and selection of song.",
    category: "team",
    maxPart: 4,
    type: "Music"
  },
...
Event.create(
  {
    ...
    number: 28,
    rules:
      "i)	A College/Institution may send one participant. <br>ii)	The contents of the poem should not be vulgar or cheap. <br>iii)	Each participant shall be allowed not less than 3 minutes and not more than 4 minutes. ",
    category: "solo",
    maxPart: 1,
...
Event.create(
  {
    ...
    number: 30,
    rules:
      "i)	A College/ Institution can enter only one speaker. <br>ii)	The time allotted to a speaker is not less than 4 minutes and not more than 6 minutes. <br>iii)	The Cultural Coordinator will send topics well in advance. <br>iv)	Paper reading will not be allowed. ",
    category: "solo",
    maxPart: 1,
    type: "LITERARY EVENTS"
  },
...
Event.create(
  {
    ...
    number: 36,
    rules:
      "i)	Each College/Instt. can send one participant. <br>ii)	The subject will be some portrait or object. <br>iii)	Event will be conducted on the spot. <br>iv)	The competitors shall bring their own material. <br>v)	Duration will not be more than 2 hours and 30 minutes. ",
    category: "solo",
    maxPart: 1,
    type: "FINE ARTS"
  },
